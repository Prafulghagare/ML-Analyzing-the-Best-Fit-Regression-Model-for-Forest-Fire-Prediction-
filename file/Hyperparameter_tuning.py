...
## Cross validation Lasso  model class Lassocv
from sklearn.linear_model import LassoCV
LassoCV = LassoCV(cv =5)
LassoCV.fit(x_train_scaled, y_train)


## after fitting model checking  lasso alpha_ anf alphas_
LassoCV.alpha_
LassoCV.alphas_
...
## selecting model for cross validation
...
## checking alpha after fitting cross validation model
RidgeCV.alpha_
RidgeCV.alphas
